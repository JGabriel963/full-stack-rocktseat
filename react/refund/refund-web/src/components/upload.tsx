...
export function Upload({ filename = null, ...rest }: Props) {
  return (
    <div>
      ...
      <div className="w-full h-12 flex items-center rounded-lg border border-gray-200 text-sm text-gray-100 bg-transparent outline-none">
        ...
        >
          <img src={uploadSvg} alt="Ícone de upload" className="size-6" />
        </label>
      </div>
    </div>
  );
